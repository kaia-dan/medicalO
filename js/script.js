...
$(function() {  //$(function() {});  jquery를 호출하겠다.
    $(".visual .visual_list").slick({  //$("적용해줄 클래스명").slick- 선택한 클래스에 slick을 적용하겠다
...
$(function() {  //$(function() {});  jquery를 호출하겠다.
    $(".our_sec .our_slide").slick({  //$("적용해줄 클래스명").slick- 선택한 클래스에 slick을 적용하겠다
        arrows: false, //화살표 사용안함
        dots: false, //닷츠
        autoplay: true, //자동재생
        infinite: true,
...
$(function() {  //$(function() {});  jquery를 호출하겠다.
    $(".bafter_sec .bafter_list").slick({  //$("적용해줄 클래스명").slick- 선택한 클래스에 slick을 적용하겠다
        arrows: false, //화살표 사용안함
        dots: false, //닷츠
        autoplay: true, //자동재생
        infinite: true,
